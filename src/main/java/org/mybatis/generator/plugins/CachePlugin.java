...
public class CachePlugin extends PluginAdapter {
	public enum CacheProperty {
		EVICTION("cache_eviction", "eviction"), FLUSH_INTERVAL("cache_flushInterval", "flushInterval"), READ_ONLY("cache_readOnly", "readOnly"), SIZE("cache_size", "size"), TYPE("cache_type", "type");
