...
/**
 * This plugin generates an SqlMapConfig file containing sqlMap entries for all generated SQL maps. This demonstrates hooking into the code generation lifecycle
 * and generating additional XML files.
 * <p>
...
public class SqlMapConfigPlugin extends PluginAdapter {
	...
	public List<GeneratedXmlFile> contextGenerateAdditionalXmlFiles() {
		...
		GeneratedXmlFile gxf = new GeneratedXmlFile(document, properties.getProperty("fileName", "SqlMapConfig.xml"),
