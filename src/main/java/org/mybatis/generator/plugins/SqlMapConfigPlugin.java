...
public class SqlMapConfigPlugin extends PluginAdapter {
	...
	public boolean validate(List<String> warnings) {
		...
		if (!stringHasValue(properties.getProperty("targetProject"))) {
			warnings.add(getString("ValidationError.18", "SqlMapConfigPlugin", "targetProject"));
			valid = false;
		}

		if (!stringHasValue(properties.getProperty("targetPackage"))) {
			warnings.add(getString("ValidationError.18", "SqlMapConfigPlugin", "targetPackage"));
			valid = false;
		}
	...
	public List<GeneratedXmlFile> contextGenerateAdditionalXmlFiles() {
		...
		GeneratedXmlFile gxf = new GeneratedXmlFile(document, properties.getProperty("fileName", "SqlMapConfig.xml"), properties.getProperty("targetPackage"), properties.getProperty("targetProject"), false, context.getXmlFormatter());
