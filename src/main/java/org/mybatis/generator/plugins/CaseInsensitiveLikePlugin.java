...
/**
 * This plugin demonstrates adding methods to the example class to enable case-insensitive LIKE searches. It shows hows to construct new methods and add them to
 * an existing class.
 * 
