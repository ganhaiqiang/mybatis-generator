...
public class DefaultDAOMethodNameCalculator implements DAOMethodNameCalculator {
	...
	/**
	 * 1. if this will be the only updateByPrimaryKey, then the result should be updateByPrimaryKey. 2. If the other method is enabled, but there are seperate
	 * base and blob classes, then the method name should be updateByPrimaryKey 3. Else the method name should be updateByPrimaryKeyWithoutBLOBs
	 */
	...
	/**
	 * 1. if this will be the only updateByPrimaryKey, then the result should be updateByPrimaryKey. 2. If the other method is enabled, but there are seperate
	 * base and blob classes, then the method name should be updateByPrimaryKey 3. Else the method name should be updateByPrimaryKeyWithBLOBs
	 */
