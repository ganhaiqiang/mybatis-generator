...
/**
 * This class contains a somewhat comprehensive list of SQL reserved words. Since different databases have different reserved words, this list is inclusive of
 * many different databases - so it may include words that are not reserved in some databases.
 * 
