 ...
 * 
 * <ol>
 * <li>Create a Configuration object. The Configuration can be the result of a parsing the XML configuration file, or it can be created solely in Java.</li>
...
public class MyBatisGenerator {
	 ...
	 * @param warnings      Any warnings generated during execution will be added to this list. Warnings do not affect the running of the tool, but they may affect
	 *                      the results. A typical warning is an unsupported data type. In that case, the column will be ignored and generation will continue. You
	 *                      may specify <code>null</code> if you do not want warnings returned.
	...
	/**
	 * This is the main method for generating code. This method is long running, but progress can be provided and the method can be canceled through the
	 * ProgressCallback interface. This version of the method runs all configured contexts.
	 * 
	 ...
	 * 
	 * @param callback   an instance of the ProgressCallback interface, or <code>null</code> if you do not require progress information
	 * @param contextIds a set of Strings containing context ids to run. Only the contexts with an id specified in this list will be run. If the list is null or
	 *                   empty, than all contexts are run.
	...
	/**
	 * This is the main method for generating code. This method is long running, but progress can be provided and the method can be cancelled through the
	 * ProgressCallback interface.
	 * 
	 * @param callback                 an instance of the ProgressCallback interface, or <code>null</code> if you do not require progress information
	 * @param contextIds               a set of Strings containing context ids to run. Only the contexts with an id specified in this list will be run. If the list
	 *                                 is null or empty, than all contexts are run.
	 ...
	 *                                 configuration. For example, if table name = "foo" and schema = "bar", then the fully qualified table name is "foo.bar". If
